## Delta time based delay, stopwatch, function exec timing and time formatting.

### Documentation

The documentation for this crate can be found [here](https://bowarc.github.io/crates/time)
